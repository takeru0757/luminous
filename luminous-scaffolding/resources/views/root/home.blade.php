...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="list-group m-b-md">
            @foreach ($wp->posts('page')->orderBy('order')->take(5)->get() as $_post)
            <a href="{{ post_url($_post) }}" class="list-group-item">
                ...
                <p class="list-group-item-text"><small class="text-muted">{{ $_post->date($site->dateFormat) }}</small></p>
            </a>
            @endforeach
        </div>
    </div>
    <div class="col-sm-6">
        <div class="m-b clearfix">
            ...
            <p class="pull-right" style="margin:0;padding:0.0625rem 0"><a href="{{ posts_url($wp->postType('post')) }}"><span class="fa fa-clock-o"></span> Archives</a></p>
        </div>
        <div class="list-group m-b-md">

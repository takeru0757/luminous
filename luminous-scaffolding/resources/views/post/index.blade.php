    ...
    <ul class="m-b-md list-inline">
        ...
        <li>
            <ul class="list-inline" style="display:inline-block">
                ...
                <li><a href="{{ posts_url($_post->type, ['term' => $_term]) }}"><span class="fa fa-folder"></span> {{ $_term->name }}</a></li>
                @endforeach
            </ul>
        </li>
        @endif
        ...
        <li>
            <ul class="list-inline" style="display:inline-block">
                @foreach ($_terms as $_term)
                <li><a href="{{ posts_url($_post->type, ['term' => $_term]) }}"><span class="fa fa-tag"></span> {{ $_term->name }}</a></li>
                @endforeach
            </ul>
        </li>
        @endif
